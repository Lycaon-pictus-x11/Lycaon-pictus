...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Lycaon-pictus " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"node.lycaon.info", "node.lycaon.info"},
    {"node1.lycaon.info", "node1.lycaon.info"},
    {"node2.lycaon.info", "node2.lycaon.info"},
    {"node3.lycaon.info", "node3.lycaon.info"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Lycaon-pictus is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("Lycaon-pictus-start");
