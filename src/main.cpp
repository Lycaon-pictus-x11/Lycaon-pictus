...
const string strMessageMagic = "Lycaon-pictus Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Lycaon-pictus", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "now";
        CTransaction txNew;
        txNew.nTime = 1495576231;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
	...
	printf("Searching for genesis block...\n");
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x9016e44b81dbfd07c117d7d0736e0a02b3f209b7bf10e47d16237ae0594b75e6"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xd1, 0xc2, 0xd5, 0x4d };
